...
public class ListaAnimeAdapterBusquedad extends RecyclerView.Adapter<ListaAnimeAdapterBusquedad.ViewHolder> {

    private ArrayList<AnimeResults> dataset;
    private Context context;

    public ListaAnimeAdapterBusquedad(ArrayList<AnimeResults> dataset, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_busquedad, parent, false);
